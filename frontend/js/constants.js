const contractAddress = "0x60e5544BD2b9572187Cf0D5F5A42855473DEf6DC"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Chin Nations NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Chin Nations NFT Project is aimed at bringing a unique experience to NFT holders where not only investing in a NFT but also a graphic novel that will be shipped out to all NFT holders at the time of completion.';
